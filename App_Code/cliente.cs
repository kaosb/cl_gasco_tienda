...
public class cliente
{
   ...
   (System.Reflection.MethodBase.GetCurrentMethod().DeclaringType);
    ...
    public datosClientes checkUserbyRut(string rut)
    {
        ...
        System.Xml.Serialization.XmlSerializer x = new System.Xml.Serialization.XmlSerializer(_ret.GetType());
        StringWriter sww = new StringWriter();
        XmlWriter writer = XmlWriter.Create(sww);
        x.Serialize(writer, _ret);
        String xml = sww.ToString();
        log.Debug("ZKSK_CONSULTA_CLI_RUTRet :" + xml);
