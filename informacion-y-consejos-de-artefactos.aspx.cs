...
public partial class informacion_y_consejos_de_artefactos : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        {
            String panel = Request.QueryString["p"].ToString();
            ...
            {
                case "1":
                    pnlInstalacion.Visible = true;
                    ImageButton i = (ImageButton)ibb1;
                    setib(i);
                    break;
                case "2":
                    pnlRecomendaciones.Visible = true;
                    ImageButton i2 = (ImageButton)ibb2;
                    setib(i2);
                    break;
                case "3":
                    pnlRecomendaciones.Visible = true;
                    ImageButton i3 = (ImageButton)ibb3;
                    setib(i3);
                    break;
